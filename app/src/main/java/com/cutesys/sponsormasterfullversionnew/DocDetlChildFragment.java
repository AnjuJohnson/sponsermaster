...
import com.cutesys.sponsormasterfullversionnew.Adapterclasses.DocDetailsAdapter;
...
public class DocDetlChildFragment extends Fragment implements View.OnClickListener{
    ...
    private DocDetailsAdapter mDocDetailsAdapter;
                    ...
                    if (intent.getAction().equals("EMPTYGET")) {
                        ...
                        if (intent.getAction().equals("COMPANYGET")) {
                            ...
                            for (int i = 0; i < mProfileItem.getDatatitle().length; i++) {
                                ...
                                item.set_name(StringUtils.capitalize(mProfileItem.getDatatitle()[i]
                                        .toLowerCase().trim()));
                                item.set_address(mProfileItem.getDatadls()[i]);
                                item.set_phone(mProfileItem.getDataowner()[i]);
                                item.set_code(mProfileItem.getDatastart()[i]);
                                item.set_email(mProfileItem.getDataend()[i]);
                                dataItem.add(item);
                            }
                        ...
                        mDocDetailsAdapter = new DocDetailsAdapter(getActivity(), dataItem, status);

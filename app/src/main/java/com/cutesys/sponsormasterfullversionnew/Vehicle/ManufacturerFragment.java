...
public class ManufacturerFragment extends Fragment implements View.OnClickListener{
    ...
    private void InitIdView(View rootView){
        ...
        mTitle.setText("Manufacturer List");
        msubtext.setText("Manufacturer");
    ...
    private void InitGetData(boolean temp){
        ...
        if(mConfig.isOnline(getActivity())){
            LoadManufacturerInitiate mLoadManufacturerInitiate = new LoadManufacturerInitiate(sPreferences.getString("ID", ""),
    ...
    public void onClick(View view) {
        ...
        switch (buttonId){
            ...
            case R.id.empty_label_retry:
                ...
                break;
            case R.id.mAdd:
                Intent intent = new Intent(getActivity(),AddManufacturerActivity.class);

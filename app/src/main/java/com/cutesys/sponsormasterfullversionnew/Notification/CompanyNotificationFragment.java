...
public class CompanyNotificationFragment extends Fragment implements View.OnClickListener {
    ...
    String [] filterdata ={
            "All", "Municipal License", "Commercial Registration", "Municipal Baladiya",
    ...
    private void InitIdView(View rootView){
        ...
        mFilter = "all";
        mTitle.setText("Company - All Notification");
        InitView();
    }
        ...
        try {
            new AsyncTask<String, String, String>() {
                ...
                protected void onPostExecute(String result) {
                    ...
                    mFilterAdapter = new FilterAdapter(getActivity(), filterdata,"company");
    ...
    public class LoadAllNotificationInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            if(mFilter.equals("all")){
                result = httpOperations.doCOMPANYALLNOTIFICATIONLIST(mId, mAuthorization,
                        mDate);
            } else {
                result = httpOperations.doCMPYNOTIFICATIONLIST(mId, mAuthorization, mDate,
                        mFilter.replace(" ", "%20"));
            }
            return result;
        }

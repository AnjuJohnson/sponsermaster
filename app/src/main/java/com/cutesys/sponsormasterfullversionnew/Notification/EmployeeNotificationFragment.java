...
import com.cutesys.sponsormasterfullversionnew.Adapterclasses.FilterAdapter;
...
public class EmployeeNotificationFragment extends Fragment implements View.OnClickListener {
    ...
    private BottomMenuNotificationFragment mBottomMenuNotificationFragment;
    ...
    String [] filterdata ={
            "All", "Qatar ID ", "Visa", "Passport",
            "Health Card", "Insurance","Driving Licence"
    };
    @Override
    ...
    private void InitIdView(View rootView){
        ...
        mBottomMenuNotificationFragment = (BottomMenuNotificationFragment) getChildFragmentManager()
        ...
        mFilter = "all";
        mTitle.setText("Employee - All Notification");
        InitView();
    }
        ...
        try {
            new AsyncTask<String, String, String>() {
                ...
                protected void onPostExecute(String result) {
                    ...
                    mFilterAdapter = new FilterAdapter(getActivity(), filterdata,"employee");
    ...
    public void onResume() {
        ...
        mBottomMenuNotificationFragment.listdate.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mBottomMenuNotificationFragment.listfilter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(progress_view.getVisibility() == View.VISIBLE) {
                    ...
                    Animation slide = AnimationUtils.loadAnimation(getActivity(), R.anim.bottom_up);
                    popuplayoutfilter.startAnimation(slide);
                    popuplayoutfilter.setVisibility(View.VISIBLE);
                    popuplayoutcalendar.setVisibility(View.GONE);
                }
            }
        });
    ...
    public class LoadAllNotificationInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            if(mFilter.equals("all")){
                result = httpOperations.doEMPLOYEEALLNOTIFICATIONLIST(mId, mAuthorization,
                        mDate);
            } else {
                result = httpOperations.doEMPLOYEENOTIFICATIONLIST(mId, mAuthorization, mDate,
                        mFilter.replace(" ", "%20"));
            }
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("employee_notification");
                        ...
                        for (int i = 0; i < feedArray.length(); i++) {
                            ...
                            if((!feedObj.getString("notification_data").equals(""))
                                ...
                                item.set_name(StringUtils.capitalize(feedObj.getString("notification_data")
                                        .toLowerCase().trim()));

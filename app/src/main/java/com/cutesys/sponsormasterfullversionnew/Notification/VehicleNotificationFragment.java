...
public class VehicleNotificationFragment extends Fragment implements View.OnClickListener {
    ...
    private void InitIdView(View rootView){
        ...
        mFilter = "all";
        mTitle.setText("Vehicle - All Notification");
        InitView();
    }
        ...
        try {
            new AsyncTask<String, String, String>() {
                ...
                protected void onPostExecute(String result) {
                    ...
                    mFilterAdapter = new FilterAdapter(getActivity(), filterdata,"vehicle");
    ...
    public class LoadAllNotificationInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            if(mFilter.equals("all")){
                result = httpOperations.doVEHICLEALLNOTIFICATIONLIST(mId, mAuthorization,
                        mDate);
            } else {
                result = httpOperations.doVEHICLENOTIFICATIONLIST(mId, mAuthorization, mDate,
                        mFilter.replace(" ", "%20"));
            }
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("vehicle_notification");

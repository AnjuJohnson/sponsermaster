...
public class RPVisaMedicalNotiFragment extends Fragment implements View.OnClickListener {
    ...
    private void InitIdView(View rootView){
        ...
        mTitle.setText("RP Visa Medical Notification");
        InitView();
    }
    ...
    public class LoadAllNotificationInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.dorpvisamedicalnotificationday(mId, mAuthorization,mday);
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("medical_visa_validity_expiry_list");
                        ...
                        for (int i = 0; i < feedArray.length(); i++) {
                            ...
                            if((!feedObj.getString("notification_data").equals(""))
                                ...
                                if (feedObj.getString("last_date").trim().equals("")) {
                                    item.setlast_date("None");
                                } else {
                                    item.setlast_date((feedObj.getString("last_date")
                                            .toLowerCase().trim()));
                                }
                                dataItem.add(item);
                            }

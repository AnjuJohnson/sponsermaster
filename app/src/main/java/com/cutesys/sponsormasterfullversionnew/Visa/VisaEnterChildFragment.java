...
public class VisaEnterChildFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.visa_fragment, container, false);
    ...
    private void InitGetData(boolean temp){
        ...
        if(mConfig.isOnline(getActivity())){
            LoadVisaEnterInitiate mLoadVisaEnterInitiate = new LoadVisaEnterInitiate(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""), temp, String.valueOf(start));
            mLoadVisaEnterInitiate.execute((Void) null);
        }else {
    ...
    public class LoadVisaEnterInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {

        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadVisaEnterInitiate(String id, String authorization, boolean status, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.doVisaEnteredList(mId, mAuthorization,mStart);
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        for (int i = 0; i < feedArray.length(); i++) {
                            ...
                            if ((!feedObj.getString("visa_applicant_name").equals(""))
                                ...
                                if(feedObj.getString("visa_type_name").trim().equals("")){
                                    ...
                                    item.set_code(StringUtils.capitalize(feedObj.getString("visa_type_name")
                                            .toLowerCase().trim()));
                                }
                                ...
                                if(feedObj.getString("visa_entry_date").trim().equals("")){
                                    ...
                                    item.set_entry(feedObj.getString("visa_entry_date"));
                                }
                                if(feedObj.getString("visa_type_name").trim().equals("")){
                                    item.set_address("None");
                                }else {
                                    item.set_address(feedObj.getString("visa_type_name"));
                                }
                        ...
                        start = dataItem.size();
                        mVisaListAdapter = new VisaListAdapter(getActivity(), dataItem,"enter");

 ...
 */
public class HomeEmpListAdapter extends RecyclerView.Adapter implements FastScroller.SectionIndexer {
    ...
    public HomeEmpListAdapter(Activity activity, ArrayList<ListItem> listitem,
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView name, location, mail, call,desig,id;
        ImageView profile,action_more;
        LinearLayout visible,cardview_linearlayout,action_morelayout,invisible_1,invisible_2,desig_layout;
        ...
        public ViewHolder(View view) {
            ...
            id = (TextView) view.findViewById(R.id.eid);
            ...
            invisible_1 = (LinearLayout) view.findViewById(R.id.invisible_1);
            invisible_2 = (LinearLayout) view.findViewById(R.id.invisible_2);
            desig_layout = (LinearLayout) view.findViewById(R.id.desig_layout);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        mViewHolder.invisible_1.setVisibility(View.GONE);
        mViewHolder.invisible_2.setVisibility(View.GONE);
        mViewHolder.name.setText(item.get_name());
       // mViewHolder.id.setText(item.get_id());

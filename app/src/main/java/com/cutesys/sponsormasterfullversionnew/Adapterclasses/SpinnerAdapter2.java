...
public class SpinnerAdapter2 extends BaseAdapter {
    ...
    public SpinnerAdapter2(Context context, ArrayList<AllListItem> mListitem, String status) {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        else if(mStatus.equals("Designation")){
            TextView cmpname = (TextView) v.findViewById(R.id.cmpname);
            cmpname.setText(item.getEmployee_designation());
        }
        return v;
    }

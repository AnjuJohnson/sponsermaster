...
public class CpyVehicleAdapter extends RecyclerView.Adapter implements FastScroller.SectionIndexer {
    ...
    public CpyVehicleAdapter(Activity context, ArrayList<ListItem> listitem, String Status){
        mContext = context;
        mListItem = listitem;
        mStatus = Status;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        return new CpyVehicleAdapter.ViewHolder(rootView);
    }

    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, final int position) {
        item = mListItem.get(position);
        CpyVehicleAdapter.ViewHolder mViewHolder = (CpyVehicleAdapter.ViewHolder) viewHolder;

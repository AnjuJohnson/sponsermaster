 ...
 */
public class ListHeadingOneAdapter extends RecyclerView.Adapter {
    ...
    public ListHeadingOneAdapter(Activity context, ArrayList<ListItem> listitem){
        mContext = context;
        mListItem = listitem;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View rootView = LayoutInflater.
                from(mContext).inflate(R.layout.listviewheadingone_item, null, false);

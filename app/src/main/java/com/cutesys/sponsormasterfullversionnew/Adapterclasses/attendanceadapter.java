...
public class attendanceadapter extends RecyclerView.Adapter<attendanceadapter.ViewHolder>  {
    ArrayList<attendanceitem> mListItem;
    Activity mContext;
    String status;
    View v;


    public attendanceadapter(Activity context, ArrayList<attendanceitem> listItem, String status) {
        mListItem = listItem;
        mContext = context;
        this.status = status;
    ...
    public attendanceadapter(ArrayList<attendanceitem> data) {
        this.mListItem = data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(AttendanceListFragment.myOnClickListener);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
      ...
      emp_id.setText(mListItem.get(position).getemployee_employment_id());
       ...
       punch_in_ip.setText("In: " +mListItem.get(position).getattendance_punch_in_ip());
       punch_out_ip.setText("Out: " +mListItem.get(position).getattendance_punch_out_ip());

        final attendanceitem dataItem = mListItem.get(position);

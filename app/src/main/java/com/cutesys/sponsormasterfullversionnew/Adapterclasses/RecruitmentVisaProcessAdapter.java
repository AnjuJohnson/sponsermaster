...
public class RecruitmentVisaProcessAdapter extends RecyclerView.Adapter<RecruitmentVisaProcessAdapter.MyViewHolder>  {
    ...
    public RecruitmentVisaProcessAdapter(Context context, ArrayList<RecruitmentListItem> listItem, String status) {
        mListItem = listItem;
        mContext = context;
        Status = status;
    }
    ...
    public RecruitmentVisaProcessAdapter(ArrayList<RecruitmentListItem> data){
        this.mListItem=data;
    }


    @Override
    public RecruitmentVisaProcessAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RecruitmentVisaProcessAdapter.MyViewHolder myViewHolder = new RecruitmentVisaProcessAdapter.MyViewHolder(view);
        return myViewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(final RecruitmentVisaProcessAdapter.MyViewHolder holder, final int listPosition) {

...
import com.cutesys.sponsormasterfullversionnew.ADDModule.AddCategoryActivity;
...
import com.cutesys.sponsormasterfullversionnew.Adapterclasses.RecruitSettingsTwoItemAdapter;
...
public class CategoryFragment extends Fragment implements View.OnClickListener {
    ...
    private void InitIdView(View rootView){
        ...
        mTitle.setText("Category List");
        msubtext.setText("Category");
        msubtitle.setText("Job Position");
        InitGetData(false);
    }
    ...
    private void InitGetData(boolean temp){
        ...
        if(mConfig.isOnline(getActivity())){
            CategoryFragment.LoadCountryInitiate mLoadCategoryInitiate = new CategoryFragment.LoadCountryInitiate(sPreferences.getString("ID", ""),
    ...
    public class LoadCountryInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.dorecruitmentcategorylistList(mId, mAuthorization,mStart);
            return result;
        }
                    ...
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        for (int i = 0; i < feedArray.length(); i++) {
                            ...
                            if((!feedObj.getString("job_category_name").equals(""))
                                ...
                                item.set_name(StringUtils.capitalize(feedObj.getString("job_category_name")
                                        .toLowerCase().trim()));
                                item.set_manufacture(StringUtils.capitalize(feedObj.getString("job_position")
                                        .toLowerCase().trim()));
                                dataItem.add(item);
                            }
                        }

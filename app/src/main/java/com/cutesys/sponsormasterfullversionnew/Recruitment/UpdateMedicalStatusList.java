...
public class UpdateMedicalStatusList extends Fragment {
    ...
    private void InitGetData(boolean temp) {
        ...
        if(mConfig.isOnline(getActivity())){
            LoadUpdateMedicalStatusListInitiate mLoadUpdateMedicalStatusListInitiate= new LoadUpdateMedicalStatusListInitiate(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""), temp, String.valueOf(start));
            mLoadUpdateMedicalStatusListInitiate.execute((Void) null);
        }else {
...
//
//    }
    public class LoadUpdateMedicalStatusListInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {

        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadUpdateMedicalStatusListInitiate(String id, String authorization, boolean status, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.doupdatemedicalstatusList(mId, mAuthorization,mStart);;;
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("final_candidate_list");
                        ...
                        start = data.size();
                        mMedicalStatusAdapter = new MedicalStatusAdapter(getActivity(), data,"updatemedicalstatus");

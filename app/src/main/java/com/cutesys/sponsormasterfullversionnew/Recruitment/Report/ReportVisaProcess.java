...
public class ReportVisaProcess extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myOnClickListener = new ReportVisaProcess.MyOnClickListener(getActivity());
        InitIdView(rootView);
        return rootView;
    }
    ...
    private void InitGetData(boolean temp) {
        ...
        if(mConfig.isOnline(getActivity())){
            LoadVisaprocessreportInitiate mLoadVisaprocessreportInitiate= new LoadVisaprocessreportInitiate(sPreferences.getString("ID", ""),
...
//    }
    public class  LoadVisaprocessreportInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.doreportvisaprocess(mId, mAuthorization,mStart);;;
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("report_process_visa");
                        for (int i = 0; i < feedArray.length(); i++) {
                            ...
                            if ((!feedObj.getString("fullname").equals(""))
                                ...
                                if (feedObj.getString("designation").trim().equals("")) {
                                    ...
                                    item.setcandidate_designation(StringUtils.capitalize(feedObj.getString("designation")
                                            .toLowerCase().trim()));
                                }
                                ...
                                if (feedObj.getString("visa_status").trim().equals("")) {
                                    ...
                                    item.setvisa_status(StringUtils.capitalize(feedObj.getString("visa_status")
                                            .toLowerCase().trim()));
                                }
                        ...
                        start = data.size();
                        mVisaProcessAdapter = new VisaProcessAdapter(getActivity(), data,"reportvisaprocess");

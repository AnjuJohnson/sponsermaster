...
public class CountryFragment extends Fragment implements View.OnClickListener {
    ...
    private void InitIdView(View rootView){
        ...
        mTitle.setText("Country List");
        msubtext.setText("Country");
    ...
    private void InitGetData(boolean temp){
        ...
        if(mConfig.isOnline(getActivity())){
            CountryFragment.LoadManufacturerInitiate mLoadManufacturerInitiate = new CountryFragment.LoadManufacturerInitiate(sPreferences.getString("ID", ""),
    ...
    public void onClick(View view) {
        ...
        switch (buttonId){
            ...
            case R.id.empty_label_retry:
                ...
                break;
            case R.id.mAdd:
                Intent intent = new Intent(getActivity(),AddCountry.class);

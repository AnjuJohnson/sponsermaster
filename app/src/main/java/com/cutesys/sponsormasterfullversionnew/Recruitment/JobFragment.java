...
import com.cutesys.sponsormasterfullversionnew.ADDModule.AddJob;
...
public class JobFragment extends Fragment implements View.OnClickListener {
    ...
    private void InitGetData(boolean temp){
        ...
        if(mConfig.isOnline(getActivity())){
            JobFragment.LoadManufacturerInitiate mLoadManufacturerInitiate = new JobFragment.LoadManufacturerInitiate(sPreferences.getString("ID", ""),

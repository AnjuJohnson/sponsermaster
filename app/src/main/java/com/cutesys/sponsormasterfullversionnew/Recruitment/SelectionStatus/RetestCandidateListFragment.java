...
public class RetestCandidateListFragment  extends Fragment implements View.OnClickListener {
    ...
    private void InitGetData(boolean temp){
        ...
        if(mConfig.isOnline(getActivity())){
            LoadRetestCandidateListInitiate mLoadRetestCandidateListInitiate = new LoadRetestCandidateListInitiate(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""), temp, String.valueOf(start));
            mLoadRetestCandidateListInitiate.execute((Void) null);
        }else {
    ...
    public class LoadRetestCandidateListInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {

        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadRetestCandidateListInitiate(String id, String authorization, boolean status, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.doRetestCandidateList(mId, mAuthorization,mStart);
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("retest_list");

...
public class MedicalFailedList extends Fragment {
    ...
    private void InitGetData(boolean temp) {
        ...
        if(mConfig.isOnline(getActivity())){
            LoadMedicalFailedListInitiate mLoadMedicalFailedListInitiate= new LoadMedicalFailedListInitiate(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""), temp, String.valueOf(start));
            mLoadMedicalFailedListInitiate.execute((Void) null);
        }else {
...
//
//    }
    public class LoadMedicalFailedListInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {

        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadMedicalFailedListInitiate(String id, String authorization, boolean status, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.domedicalfailedList(mId, mAuthorization,mStart);;;
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("medical_failed_list");
                        ...
                        start = data.size();
                        mMedicalStatusAdapter = new MedicalStatusAdapter(getActivity(), data,"medicalfailedlist");

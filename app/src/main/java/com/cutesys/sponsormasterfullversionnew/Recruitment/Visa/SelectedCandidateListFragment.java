...
import com.cutesys.sponsormasterfullversionnew.Adapterclasses.SelectedCandidateAdapter;
...
public class SelectedCandidateListFragment extends Fragment {
...
//    private RecyclerView.LayoutManager layoutManager;
    ...
    Context c;
    SelectedCandidateAdapter mSelectedCandidateListAdapter;
    int start = 0;
    int side;
...
//    }
    public class LoadSelectedCandidateInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.doselectedcandidateList(mId, mAuthorization,mStart);;;
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        start = data.size();
                        mSelectedCandidateListAdapter = new SelectedCandidateAdapter(getActivity(), data,"selectedlist");
                        cmpy_recycler9.setAdapter(mSelectedCandidateListAdapter);

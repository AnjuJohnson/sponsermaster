...
import com.cutesys.sponsormasterfullversionnew.Adapterclasses.RejectedCandidateAdapter;
...
public class SelectedCandidateListRecruitment  extends Fragment implements View.OnClickListener {
    ...
    RejectedCandidateAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new RejectedCandidateAdapter(dataItem);
    ...
    private void InitGetData(boolean temp){
        ...
        if(mConfig.isOnline(getActivity())){
            LoadSelectedCandidateListRecruitmentInitiate mLoadSelectedCandidateListRecruitmentInitiate = new LoadSelectedCandidateListRecruitmentInitiate(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""), temp, String.valueOf(start));
            mLoadSelectedCandidateListRecruitmentInitiate.execute((Void) null);
        }else {
    ...
    public class LoadSelectedCandidateListRecruitmentInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {

        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadSelectedCandidateListRecruitmentInitiate(String id, String authorization, boolean status, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.doSelectedCandidateListRecruitment(mId, mAuthorization,mStart);
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("selected_list");
                        ...
                        start = dataItem.size();
                        mAdapter = new RejectedCandidateAdapter(getActivity(), dataItem, "cpy");
                        cmpy_recycler9.setAdapter(mAdapter);
                        System.out.println(result);

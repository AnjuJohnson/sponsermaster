...
public class TravelStatus extends Fragment {
...
//        }
    ...
    public class ViewpagerAdapter extends FragmentPagerAdapter {
        ...
        private String[] titles = {"Notified Candidates", "Travelling Candidates","Travelled Candidates List"};
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    f = new NotifiedCandidateFragment();
                    return f;
                case 1:
                    f = new TravellingCandidateFragment();
                    return f;
                case 2:
                    f = new TravelledCandidateFragment();
                    return f;

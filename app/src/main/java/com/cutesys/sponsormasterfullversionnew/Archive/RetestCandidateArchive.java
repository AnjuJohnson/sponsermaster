...
public class RetestCandidateArchive extends Fragment {
...
//        title3 = ((TextView) rootView.findViewById(R.id.title3));
        ...
        mTitle.setText("Retest Candidate Archive");
        data = new ArrayList<>();
        InitGetData(false);
    }
    ...
    private void InitGetData(boolean temp) {
        ...
        if(mConfig.isOnline(getActivity())){
            LoadRetestCandidateArchiveInitiate mLoadRetestCandidateArchiveInitiate= new LoadRetestCandidateArchiveInitiate(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""), temp, String.valueOf(start));
            mLoadRetestCandidateArchiveInitiate.execute((Void) null);
        }else {
...
//
//    }
    public class  LoadRetestCandidateArchiveInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {

        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadRetestCandidateArchiveInitiate(String id, String authorization, boolean status, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.doretestcandidatearchive(mId, mAuthorization,mStart);;;
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("retest_archive_list");
                        ...
                        start = data.size();
                        mRecruitmentArchiveAdapter = new RecruitmentArchiveAdapter(getActivity(), data,"retestarchive");

...
public class CandidateArchiveFragment extends Fragment {
...
//        title3 = ((TextView) rootView.findViewById(R.id.title3));
        ...
        mTitle.setText("Candidate Archive");
        data = new ArrayList<>();
        InitGetData(false);
    }
    ...
    private void InitGetData(boolean temp) {
        ...
        if(mConfig.isOnline(getActivity())){
            LoadCandidateArchiveInitiate mLoadCandidateArchiveInitiate= new  LoadCandidateArchiveInitiate(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""), temp, String.valueOf(start));
            mLoadCandidateArchiveInitiate.execute((Void) null);
        }else {
...
//
//    }
    public class  LoadCandidateArchiveInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {

        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadCandidateArchiveInitiate(String id, String authorization, boolean status, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.docandidatearchive(mId, mAuthorization,mStart);;;
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("candidate_archive_list");
                        ...
                        start = data.size();
                        mRecruitmentArchiveAdapter = new RecruitmentArchiveAdapter(getActivity(), data,"candidatearchive");

...
public class SelectedCandidateArchive extends Fragment {
...
//        title3 = ((TextView) rootView.findViewById(R.id.title3));
        ...
        mTitle.setText("Selected Candidate Archive");
        data = new ArrayList<>();
        InitGetData(false);
    }
    ...
    private void InitGetData(boolean temp) {
        ...
        if(mConfig.isOnline(getActivity())){
            LoadSelectedCandidateArchiveInitiate mLoadSelectedCandidateArchiveInitiate= new  LoadSelectedCandidateArchiveInitiate(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""), temp, String.valueOf(start));
            mLoadSelectedCandidateArchiveInitiate.execute((Void) null);
        }else {
...
//
//    }
    public class  LoadSelectedCandidateArchiveInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {

        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadSelectedCandidateArchiveInitiate(String id, String authorization, boolean status, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.doselectedcandidatearchive(mId, mAuthorization,mStart);;;
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("selected_candidate_archive_list");
                        ...
                        start = data.size();
                        mRecruitmentArchiveAdapter = new RecruitmentArchiveAdapter(getActivity(), data,"selectedarchive");

...
import com.cutesys.sponsormasterfullversionnew.Adapterclasses.attendanceadapter;
...
public class AttendanceListFragment  extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataItem = new ArrayList<attendanceitem>();
        mAdapter = new attendanceadapter(dataItem);
    ...
    private void InitIdView(View rootView){
        ...
        mTitle.setText("Attendence List");
    ...
    public class LoadAttendanceInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.doattendanceList1(mId, mAuthorization,mStart);
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        start = dataItem.size();
                        mAdapter = new attendanceadapter(getActivity(), dataItem,"cpy");
                        cmpy_recycler3.setAdapter(mAdapter);
                        System.out.println(result);

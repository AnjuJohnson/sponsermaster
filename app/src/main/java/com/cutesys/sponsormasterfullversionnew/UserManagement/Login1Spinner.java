 ...
 */
public class Login1Spinner extends BaseAdapter {
    private Context mcontext;
    private ArrayList<logindetailsitem> listitem;

    public Login1Spinner(Context context,ArrayList<logindetailsitem> mListitem) {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        name.setText(item.getemployee_designation());

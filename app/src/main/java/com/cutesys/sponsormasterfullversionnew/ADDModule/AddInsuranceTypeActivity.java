...
public class AddInsuranceTypeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addinsurancetype);
    ...
    private void InitIdView() {
        ...
        mTitle.setText("Add Insurance Type");
    }
    ...
    private void Close_view(){
        Intent intent = new Intent(AddInsuranceTypeActivity.this,DashboardActivity.class);
        intent.putExtra("PAGE","INSURANCE TYPE");
    ...
    public class LoadAddInsuranceTypeInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.doAddInsuranceType(mId, mAuthorization, mdesignation);
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(404))) {
                        ...
                        CustomToast.info(getApplicationContext(),"Insurance Type Already Exist").show();

                    }else if (jsonObj.getString("status").equals(String.valueOf(200))) {

                        addinsurance.setText("");
                        CustomToast.success(getApplicationContext(),"Insurance Type Added Successfully").show();
                       // close_reveal();
                    }
                }

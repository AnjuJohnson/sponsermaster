...
public class AddCountry extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addcountry);
    ...
    private void InitIdView() {
        ...
        mTitle.setText("Add Country");
    }

    private void AddManufacturer() {
        Config mConfig = new Config(getApplicationContext());
        if (mConfig.isOnline(getApplicationContext())) {
            AddCountry.LoadAddManufacturerInitiate mLoadAddManufacturerInitiate = new AddCountry.LoadAddManufacturerInitiate(sPreferences.getString("ID", ""),
    ...
    private void Close_view(){
        Intent intent = new Intent(AddCountry.this,DashboardActivity.class);
    ...
    public class LoadAddManufacturerInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.doAddCountry(mId, mAuthorization, mdesignation);
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(404))) {
                        ...
                        addManufacturer.setText("");
                        CustomToast.success(getApplicationContext(), "Country Added Successfully").show();
                        // close_reveal();
                    }
                }

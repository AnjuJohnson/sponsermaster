...
public class AddAllowanceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addallowance);
    ...
    private void Close_view(){
        Intent intent = new Intent(AddAllowanceActivity.this,DashboardActivity.class);
    ...
    public class LoadAddManufacturerInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.doAddAllowance(mId, mAuthorization, mdesignation);
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(404))) {
                        ...
                        CustomToast.info(getApplicationContext(), "Allowance already exist").show();

                    } else if (jsonObj.getString("status").equals(String.valueOf(200))) {

                        addManufacturer.setText("");
                        CustomToast.success(getApplicationContext(), "Allowance Added Successfully").show();
                       // close_reveal();
                    }
                }

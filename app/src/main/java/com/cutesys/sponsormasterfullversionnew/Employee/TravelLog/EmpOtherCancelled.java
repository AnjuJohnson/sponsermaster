...
public class EmpOtherCancelled extends Fragment implements View.OnClickListener {
    ...
    private void InitGetData(boolean temp) {
        ...
        if (mConfig.isOnline(getActivity())) {
            LoadOtherCancelled mLoadOtherCancelled = new LoadOtherCancelled(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""),String.valueOf(start));
            mLoadOtherCancelled.execute((Void) null);
        } else {
    ...
    public class LoadOtherCancelled extends AsyncTask<Void, StringBuilder, StringBuilder> {
        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadOtherCancelled(String id, String authorization, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.doOtherCancelledList(mId, mAuthorization,mStart);
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        start = dataItem.size();
                        mEmpTravelledAdapter = new EmpTravelledAdapter(getActivity(),getActivity(),dataItem,"othertravelcancel");

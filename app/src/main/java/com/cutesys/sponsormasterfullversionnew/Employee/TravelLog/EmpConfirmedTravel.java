...
public class EmpConfirmedTravel extends Fragment implements View.OnClickListener {
   ...
   // TextView mTitile;
    ...
    private void InitGetData(boolean temp) {
        ...
        if (mConfig.isOnline(getActivity())) {
            LoadEmployeeConfirmedTravel mLoadEmployeeConfirmedTravel = new LoadEmployeeConfirmedTravel(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""),String.valueOf(start));
            mLoadEmployeeConfirmedTravel.execute((Void) null);
        } else {
    ...
    public class LoadEmployeeConfirmedTravel extends AsyncTask<Void, StringBuilder, StringBuilder> {
        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadEmployeeConfirmedTravel(String id, String authorization, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.doConfirmedTravelList(mId, mAuthorization,mStart);
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("confirmed_travel_list");
                        ...
                        start = dataItem.size();
                        mEmpTravelledAdapter = new EmpTravelledAdapter(getActivity(),getActivity(),dataItem,"confirmed");

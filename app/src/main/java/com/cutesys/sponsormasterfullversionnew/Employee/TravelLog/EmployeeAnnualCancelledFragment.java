...
public class EmployeeAnnualCancelledFragment extends Fragment implements View.OnClickListener {
   ...
   // TextView mTitile;
    ...
    public class LoadEmployeeTravelledDetails extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.doEmployeeAnnualCancelledlledList(mId, mAuthorization, mStart);
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("cancelled_travelled_ist");
                        ...
                        start = dataItem.size();
                        mEmpTravelledAdapter = new EmpTravelledAdapter(getActivity(), getActivity(), dataItem, "cancel");

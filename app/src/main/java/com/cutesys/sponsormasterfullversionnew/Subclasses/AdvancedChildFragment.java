...
public class AdvancedChildFragment extends Fragment implements View.OnClickListener{
            ...
            public void onReceive(Context context, Intent intent) {
                try {
                    if (intent.getAction().equals("EMPTYGET")) {
                        ...
                        int[] drawables = new int[mProfileItem.getAdvanced_title().length];
...
/*
                       ...
                       // }
                        ...
                        dataItem = new ArrayList<>();
                        for (int i = 0; i < mProfileItem.getAdvanced_title().length; i++) {

                            ListItem item = new ListItem();
                            item.set_name(StringUtils.capitalize(mProfileItem.getAdvanced_subtitile()[i]
                                    .toLowerCase().trim()));
                            item.set_email(mProfileItem.getAdvanced_title()[i]);
                            dataItem.add(item);
                        }

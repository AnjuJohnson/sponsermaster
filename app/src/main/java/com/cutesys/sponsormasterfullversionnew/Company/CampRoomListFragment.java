...
import com.cutesys.sponsormasterfullversionnew.ADDModule.add_camproom;
import com.cutesys.sponsormasterfullversionnew.Adapterclasses.camproomadapter;
...
public class CampRoomListFragment  extends Fragment implements View.OnClickListener {
    ...
    TextView  msubtext, msubtitle;


    camproomadapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.camproom_card, container, false);
        ...
        dataItem = new ArrayList<camproomlist>();
        mAdapter = new camproomadapter(dataItem);
    ...
    private void InitIdView(View rootView) {
        ...
        // mTitle.setText("CampRoom List");
        msubtext.setText("Camp Name");
        msubtitle.setText("Camp Room");
        InitGetData(false);
    ...
    public void onClick(View view) {
        ...
        switch (buttonId) {
            ...
            case R.id.fabbank:
                ...
                Intent intent = new Intent(getActivity(),add_camproom.class);
    ...
    public class LoadCampRoomListInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        LoadCampRoomListInitiate(String id, String authorization, boolean status, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.docamproomList(mId, mAuthorization, mStart);
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        start = dataItem.size();
                        mAdapter = new camproomadapter(getActivity(), dataItem, "cpy");
                        cmpy_recycler1.setAdapter(mAdapter);
                        System.out.println(result);

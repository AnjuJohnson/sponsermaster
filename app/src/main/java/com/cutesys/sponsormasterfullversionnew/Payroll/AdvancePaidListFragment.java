...
public class AdvancePaidListFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new advancepaidadapter(dataItem);
    ...
    private void InitGetData(boolean temp) {
        ...
        if (mConfig.isOnline(getActivity())) {
            LoadAdvancePaidInitiate mLoadAdvancePaidInitiate = new LoadAdvancePaidInitiate(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""), temp, String.valueOf(start));
            mLoadAdvancePaidInitiate.execute((Void) null);
        } else {
    ...
    public class LoadAdvancePaidInitiate extends AsyncTask<Void, StringBuilder, StringBuilder> {

        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadAdvancePaidInitiate(String id, String authorization, boolean status, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = web.doadvancepaidList(mId, mAuthorization, mStart);
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("advance_paid_list");
                        ...
                        start = dataItem.size();
                        mAdapter = new advancepaidadapter(getActivity(), dataItem, "cpy");
                        cmpy_recycler6.setAdapter(mAdapter);
                        System.out.println(result);

...
public class ReportAnnualTravelledBooked extends Fragment implements View.OnClickListener {
    ...
    private void InitIdView(View rootView) {
        ...
        mTitile.setText("Annual Travelled Booked");
    ...
    private void InitGetData(boolean temp) {
        ...
        if (mConfig.isOnline(getActivity())) {
            ReportAnnualTravelledBooked.LoadEmployeeTravelledDetails mLoadEmployeeTravelledDetails = new ReportAnnualTravelledBooked.LoadEmployeeTravelledDetails(sPreferences.getString("ID", ""),
    ...
    public class LoadEmployeeTravelledDetails extends AsyncTask<Void, StringBuilder, StringBuilder> {
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.doReportAnnualTravelledBookedList(mId, mAuthorization,mStart);
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("report_annual_travel_list");
                        ...
                        start = dataItem.size();
                        mEmpTravelledAdapter = new EmpTravelledAdapter(getActivity(),getActivity(),dataItem,"annualtravelbooked");

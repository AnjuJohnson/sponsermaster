...
public class ReportEmpOtherTravelled extends Fragment implements View.OnClickListener {
  //  OpenListener mListener;
    ...
    private void InitIdView(View rootView) {
        ...
        mTitile.setText("Other Travelled");
    ...
    private void InitGetData(boolean temp) {
        ...
        if (mConfig.isOnline(getActivity())) {
            LoadOtherTravelled mLoadOtherTravelled = new LoadOtherTravelled(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""),String.valueOf(start));
            mLoadOtherTravelled.execute((Void) null);
        } else {
    ...
    public class LoadOtherTravelled extends AsyncTask<Void, StringBuilder, StringBuilder> {
        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadOtherTravelled(String id, String authorization, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.doOtherTravelledList(mId, mAuthorization,mStart);
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        start = dataItem.size();
                        mEmpTravelledAdapter = new EmpTravelledAdapter(getActivity(),getActivity(),dataItem,"othertravelled");

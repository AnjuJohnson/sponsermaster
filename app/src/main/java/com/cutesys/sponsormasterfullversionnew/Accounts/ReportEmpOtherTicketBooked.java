package com.cutesys.sponsormasterfullversionnew.Accounts;
...
public class ReportEmpOtherTicketBooked extends Fragment implements View.OnClickListener {
    ImageView mMenu;
    private SharedPreferences sPreferences;
    TextView mTitile;
    private Switcher switcher;
    private TextView error_label_retry, empty_label_retry, mTitle;
    //OpenListener mListener;
    ...
    private void InitIdView(View rootView) {
        ...
        mTitile.setText("Other Travel Booked");

       // mMenu.setOnClickListener(this);
        initRecyclerView();
       // mListener=(OpenListener)getActivity();
    ...
    private void InitGetData(boolean temp) {
        ...
        if (mConfig.isOnline(getActivity())) {
            LoadEmpOtherTicketBooked mLoadEmpOtherTicketBooked = new LoadEmpOtherTicketBooked(sPreferences.getString("ID", ""),
                    sPreferences.getString("AUTHORIZATION", ""),String.valueOf(start));
            mLoadEmpOtherTicketBooked.execute((Void) null);
        } else {
    ...
    public class LoadEmpOtherTicketBooked extends AsyncTask<Void, StringBuilder, StringBuilder> {
        private String mId, mAuthorization, mStart;
        private boolean mStatus;

        LoadEmpOtherTicketBooked(String id, String authorization, String Start) {
            mId = id;
        ...
        protected StringBuilder doInBackground(Void... params) {
            ...
            StringBuilder result = httpOperations.doOtherTicketBookedList(mId, mAuthorization,mStart);
            return result;
        }
            ...
            try {
                ...
                if (jsonObj.has("status")) {
                    if (jsonObj.getString("status").equals(String.valueOf(200))) {
                        ...
                        JSONArray feedArray = jsonObj.getJSONArray("other_travel_list");
                        ...
                        start = dataItem.size();
                        mEmpTravelledAdapter = new EmpTravelledAdapter(getActivity(),getActivity(),dataItem,"otherticketbooked");
